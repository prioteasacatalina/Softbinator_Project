...
namespace Softbinator_Project.Managers
{
    public class TokenManager
    {
        /*
        private readonly UserManager<User> _userManager;
        private readonly IConfiguration _configuration; //iau info din appsettings
        ...
        public async Task<string> CreateAccessToken(User user)
        {
            ...
            var claims = new List<Claim> //adaugam in claims id, nume, rol
            {
            ...
            var creds = new SigningCredentials(key, SecurityAlgorithms.HmacSha512Signature); //algoritm criptare
